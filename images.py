...
img = resize_img(img, (20, 20))
arr = np.array(img)
board = to_board(arr, 192)
board.draw()
logimage = logimage.board_to_logimage(board)
print(logimage.left_constraints)
print(logimage.top_constraints)
# print(logimage.solve())
